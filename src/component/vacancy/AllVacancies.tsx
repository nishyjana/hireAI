    ...
    return (
        <div className="p-20 flex flex-col w-full">
            <div className="flex justify-end my-2 mb-10">
                <button
                    className="w-1/5 bottom-2 bg-hireAI p-3 rounded-3xl text-white text-center justify-end"
                    onClick={() => history.push(CREATE_VACANCY)}
                >
                    Create vacancy +
                </button>
            </div>
                        ...
                        <div className="flex flex-col m-auto px-20 py-10 w-1/2 border-2 border-b-8 rounded-4xl border-gray-300 my-2">
                            ...
                            <div className="flex justify-end my-2 mb-3 mt-10">
                                <div
                                    ...
                                    onClick={() =>
                                        history.push({
                                            pathname: LOG_PROGRESS,
                                            state: { interviewId: vacancy?._id },
                                        })
                                    }
                                >
                                    LOG PROGRESS
